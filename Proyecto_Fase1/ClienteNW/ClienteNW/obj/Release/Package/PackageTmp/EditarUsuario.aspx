<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="EditarUsuario.aspx.cs" Inherits="ClienteNW.EditarUsuario" %>
        ...
        <tr>
            ...
            <td class="auto-style3">
                <asp:TextBox ID="TextNick" runat="server"></asp:TextBox>
                        ...
                        <asp:Button ID="Button2" runat="server" Text="Buscar" OnClick="Button1_Click" style="height: 26px" />
            </td>
        </tr>
        <tr>
         ...
         <tr>
                ...
                &nbsp;</td>
                    ...
                    <td class="auto-style9">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Crear" OnClick="Button2_Click" />
                    </td>
